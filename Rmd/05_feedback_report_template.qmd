...
`r nrow(data)` people participated in the survey. The group of participants with the previous knowledge "`r best_zufriedenheit[[1,"vorwissen"]]`" have thereby evaluated the training most positively.
